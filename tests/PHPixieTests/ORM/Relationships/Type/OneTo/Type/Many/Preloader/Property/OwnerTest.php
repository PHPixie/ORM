 ...
 */
class OwnerTest extends \PHPixieTests\ORM\Relationships\Relationship\Implementation\PreloaderTest
{
    protected $owner;
    ...
    {
        return new \PHPixie\ORM\Relationships\Type\OneTo\Type\Many\Preloader\Property\Owner($this->owner);
    }
