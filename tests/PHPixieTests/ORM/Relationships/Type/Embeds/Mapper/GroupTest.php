...
namespace PHPixieTests\ORM\Relationships\Type\Embeds\Mapper;

/**
 * @coversDefaultClass \PHPixie\ORM\Relationships\Type\Embeds\Mapper\Group
 */
class GroupTest extends \PHPixieTests\AbstractORMTest
{
    ...
    public function setUp()
    {
        ...
        $this->embedsGroupMapper = new \PHPixie\ORM\Relationships\Type\Embeds\Mapper\Group(
                                        $this->relationships,
    ...
    {
        return $this->abstractMock('\PHPixie\ORM\Relationships\Type\Embeds\Handler');
    }
