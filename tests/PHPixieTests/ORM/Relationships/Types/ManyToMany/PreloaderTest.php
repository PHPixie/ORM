...
/**
 * @coversDefaultClass \PHPixie\ORM\Relationships\Types\ManyToMany\Preloader
 */
class PreloaderTest extends \PHPixieTests\ORM\Relationships\Relationship\Preloader\Result\MultipleTest
{
    ...
    protected function prepareMap($type = 'left')
    {
        ...
        $repository = $this->abstractMock('\PHPixie\ORM\Repositories\Types\Database');
    ...
    {
        $config = $this->quickMock('\PHPixie\ORM\Relationships\Types\ManyToMany\Side\Config');
    ...
    {
        return $this->abstractMock('\PHPixie\ORM\Repositories\Types\Database\Model');
    }
    ...
    {
        return new \PHPixie\ORM\Relationships\Types\ManyToMany\Preloader(
            $this->loaders,
            $this->relationship,
            $this->side,
            $this->loader,
